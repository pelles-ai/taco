...
A TACO-compliant agent **SHALL** pass all of the following checks. A hosted conformance runner that automates these checks is planned; until then, `taco inspect <url>` shows everything they examine.
